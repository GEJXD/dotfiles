...
仓库总览与安装手册在 [../README.md](../README.md)（[English](../README.en.md)）；本目录是它的分项深入文档。
...
- 想知道某个快捷键 → 看 [keybinds.md](keybinds.md)
- 想知道某个软件怎么配 → 看 [software.md](software.md)
- 想知道开机后各组件怎么起来 → 看 [compositors.md](compositors.md)
- 想知道状态栏 / 输入法 / 显示器怎么恢复 → 看对应的专门文档

> 文档描述的是仓库当前实际配置。修改配置后请同步更新对应文档，保持二者一致。
